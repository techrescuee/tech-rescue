module.exports = {
    ...
    siteTitleMeta: `Tech Rescue`, // This allows an alternative site title for meta data for pages.
    ...
    shortTitle: `Tech Rescue`, // Used for App manifest e.g. Mobile Home Screen
